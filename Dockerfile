...
ARG OPENAPI_KEY
ARG SNIPCART_PUBLIC_API_KEY
ARG SNIPCART_SECRET_API_KEY
...
ENV SNIPCART_PUBLIC_API_KEY=$SNIPCART_PUBLIC_API_KEY
ENV SNIPCART_SECRET_API_KEY=$SNIPCART_SECRET_API_KEY
