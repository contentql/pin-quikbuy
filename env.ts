...
export const env = createEnv({
  server: {
    ...
    SNIPCART_PUBLIC_API_KEY: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    SNIPCART_PUBLIC_API_KEY: process.env.SNIPCART_PUBLIC_API_KEY,
    SNIPCART_SECRET_API_KEY: process.env.SNIPCART_SECRET_API_KEY,
  },
})
